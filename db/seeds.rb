...
gym_1.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_1.save!
...
gym_2.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_2.save!
puts 'Created new gym'
...
gym_3.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_3.save!
puts 'Created new gym'
...
gym_4.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_4.save!
puts 'Created new gym'
...
gym_5.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_5.save!
puts 'Created new gym'
...
gym_6.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_6.save!
puts 'Created new gym'
...
gym_7.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_7.save!
puts 'Created new gym'
...
gym_8.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_8.save!
puts 'Created new gym'
...
gym_9.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_9.save!
puts 'Created new gym'
...
gym_10.photo.attach(io: file, filename: 'gym.png', content_type: 'image/jpg')
gym_10.save!
puts 'Created new gym'
